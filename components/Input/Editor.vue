...
el-form-item(:label="label" :error='errorMessage' class="!mb-6")
        QuillEditor.w-full( v-model:content="inputValue" :name="name" :modules="uploadImagEditor()"  :placeholder='placeholder ? placeholder : $t("enter") + label' content-type="html"  toolbar="full" ) 
</template>
